...
class TranscriptionWorker:
    ...
    async def handle_message(self, msg):
        ...
        try:
            ...
            await self._process_file(file_path, filename)

        except Exception as e:
            logger.error(f"Error processing message: {e}", exc_info=True)

    def _extract_filename(self, data: str) -> Optional[str]:
        try:
    ...
    def _save_transcription(self, result: TranscriptionResult, original_filename: str):
